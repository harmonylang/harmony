...
tests = [
    ...
    { "args": "-o rw.hfa -cNOPS=3 code/rwlock_btest.hny", "issue": "No issues", "nstates": 226 },
    { "args": "-B rw.hfa -cNOPS=3 -m rwlock=rwlock_sbs code/rwlock_btest.hny", "issue": "No issues", "nstates": 1393 },
    { "args": "-B rw.hfa -cNOPS=3 -m rwlock=rwlock_cv code/rwlock_btest.hny", "issue": "No issues", "nstates": 830 },
    { "args": "-B rw.hfa -cNOPS=3 -m rwlock=rwlock_cv_fair code/rwlock_btest.hny", "issue": "No issues", "nstates": 1019 },
    { "args": "-B rw.hfa -cNOPS=3 -m rwlock=rwlock_sbs_fair code/rwlock_btest.hny", "issue": "No issues", "nstates": 1019 },
    { "args": "-B rw.hfa -cNOPS=3 -m rwlock=rwlock_cheat code/rwlock_btest.hny", "issue": "No issues", "nstates": 217 },
