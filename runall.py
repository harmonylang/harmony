...
#    { "args": "code/PetersonInductive.hny", "issue": "No issues", "nstates": 104 },
    ...
    { "args": "-mlock=lockspec code/locktest.hny", "issue": "No issues", "nstates": 137 },
    { "args": "-mlock=taslock code/locktest.hny", "issue": "No issues", "nstates": 137 },
    { "args": "-mlock=ticket code/locktest.hny", "issue": "No issues", "nstates": 2482 },
    ...
    { "args": "code/RWtest.hny", "issue": "No issues", "nstates": 195 },
    { "args": "-mRW=RWsbs code/RWtest.hny", "issue": "No issues", "nstates": 2211 },
    { "args": "-mRW=RWcv code/RWtest.hny", "issue": "No issues", "nstates": 2068 },
    { "args": "-mRW=RWcv -msynch=synchS code/RWtest.hny", "issue": "No issues", "nstates": 4926 },
    { "args": "-mRW=RWfair code/RWtest.hny", "issue": "No issues", "nstates": 1565 },
    { "args": "-mRW=RWfair -msynch=synchS code/RWtest.hny", "issue": "No issues", "nstates": 3660 },
    { "args": "-o rw.hfa -cNOPS=2 code/RWbtest.hny", "issue": "No issues", "nstates": 226 },
    { "args": "-B rw.hfa -cNOPS=2 -m RW=RWsbs code/RWbtest.hny", "issue": "No issues", "nstates": 1393 },
    { "args": "-o rw.hfa -cNOPS=2 code/RWbtest.hny", "issue": "No issues", "nstates": 226 },
    { "args": "-B rw.hfa -cNOPS=2 -m RW=RWcv code/RWbtest.hny", "issue": "No issues", "nstates": 830 },
    { "args": "-B rw.hfa -cNOPS=2 -m RW=RWfair code/RWbtest.hny", "issue": "No issues", "nstates": 1019 },
    { "args": "-B rw.hfa -cNOPS=2 -m RW=RWcheat code/RWbtest.hny", "issue": "No issues", "nstates": 217 },
...
#    { "args": "-B file.hfa -m file=fs code/filetest.hny", "issue": "No issues", "nstates": 1704815 },
