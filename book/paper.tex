...
\newglossaryentry{blocked process}
{
  ...
  description={is a process that cannot change the state or terminate unless another
    process changes the state first.  For example, a process that is waiting
...
\begin{figure}
\includegraphics[width=\textwidth]{figures/Up1-crop.pdf}
\caption{The
...
and process~1 be at the start of the \textbf{while} loop.
...
if the process can only change the state or terminate if another process
