...
The point is that we need another property besides mutual exclusion.
...
two processes being in the critical section. Now
we need a \emph{liveness property}: we want to ensure that
\emph{eventually something good will happen}.
There are various way of specifying this,
but here we will propose the following informally: when nobody is in the
critical section, then any process should be able to move forward and
enter the critical section.  We call this \emph{progress}.
