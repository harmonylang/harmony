...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{../code/hello1.png}
\end{center}
\begin{code}
...
\texttt{False} and \texttt{True}.  The possible outputs consist of zero or
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{../code/hello3.png}
\end{center}
\begin{code}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.15\textwidth]{../code/hello4.png}
\end{center}
\begin{code}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.45\textwidth]{../code/hello5.png}
& \rule{0.05\linewidth}{0in} &
\includegraphics[width=0.45\textwidth]{../code/hello6.png} \\
...
\begin{figure}
\begin{center}
\includegraphics[width=0.9\textwidth]{../code/hello7.png}
\end{center}
\begin{code}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{../code/hello8.png}
\end{center}
\begin{code}
...
$d$\texttt{[.count]} or $d$\texttt{["count"]} (although any of those
will work).
...
\begin{code}
\textbf{assert} \texttt{queue.get}($q$) in \{ \textbf{None}, 1, 2 \}
\end{code}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../code/qtestpar.png}
\end{center}
\begin{code}
\harmonysource{qtestpar}
\end{code}
...
% \{ \texttt{.lock}: \texttt{True}, \texttt{.next}: \texttt{None}, \texttt{.value}: \texttt{None} \}.
...
\{ \texttt{.lock}: \texttt{False}, \texttt{.next}: \texttt{None}, \texttt{.value}: \texttt{None} \};
...
\{ \texttt{.lock}: \texttt{False}, \texttt{.next}: \texttt{None}, \texttt{.value}: 1 \}, as expected;
...
Now $n =\,?\mathtt{alloc}.\mathit{alloc}[0]$, which is not \texttt{None}.
...
ordered;
\item an address is a list of Harmony values.  \texttt{None} is the empty list.
