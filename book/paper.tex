...
\texttt{get}(?$q$).  Looking in the top green row,
we see that the value of $q$ is
...
\begin{enumerate}
\item[0:] initialization completed, leaving the value of $q$ at
...
We know that it is in the process of releasing $q$.\texttt{lock};
