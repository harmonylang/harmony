...
but here we will propose the following informally: if some process $p$ is
in the critical section but eventually leaves, then some process that
tries to enter the critical section should eventually be able to do so even
if $p$ never tries to enter the critical section again.
