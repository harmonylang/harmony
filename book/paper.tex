...
but here we will propose the following informally: when every process
that is in the critical section eventually leaves it and only one process
tries to enter the critical section, then it should eventually be able to do so.
