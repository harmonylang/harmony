...
section.
\item Chapter~\ref{ch:naive} presents various flawed implementations
of critical sections.
\item Chapter~\ref{ch:peterson} introduces Peterson's Algorithm, an
elegant solution to the mutual exclusion problem.
...
for mutual exclusion.  Chapter~\ref{ch:synch} presents a CXL module
...
resource they need, and a solution for the reader/writer problem.
...
systems problem of having two processes communicate over an unreliable network.
\end{itemize}
