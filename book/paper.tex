...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.35\textwidth]{../code/hello1.png}
& \rule{0.05\linewidth}{0in} &
\includegraphics[width=0.45\textwidth]{../code/hello2.png} \\
\begin{tcolorbox}[width=0.4\linewidth]
\harmonysource{hello1}
\end{tcolorbox}
& \rule{0.05\linewidth}{0in} &
\begin{tcolorbox}[width=0.4\linewidth]
\harmonysource{hello2}
\end{tcolorbox}
\\
(a) \harmonylink{code/hello1.hny} && (b) \harmonylink{code/hello2.hny}
\end{tabular}
\end{center}
\caption{Hello World!}
...
was around 1980.  In 1990, Dennis was my boss at AT\&T Bell Labs, while Brian
was my colleague in the same lab.  The first program in the book printed
the string ``hello, world''.  Since then, most programming tutorials for
pretty much any programming language start with that example.  Harmony, too,
has a Hello World program.
\autoref{fig:helloworld}(a) shows the program and the corresponding output.
...
Now look at \autoref{fig:helloworld}{b).  It has two \texttt{print} statements.
The output is another DFA, although this time there is an intermediate state.
Still, there is only one possible output, and it consists of the strings
``hello'' and ``world''.

But programs can usually have more than one execution and produce multiple
different outputs as a result.  \autoref{fig:choice} demonstrates
...
\end{code}
\caption{\harmonylink{code/hello3.hny} Nondeterministic choice}
\label{fig:choice}
\end{figure}
...
\end{code}
\caption{\harmonylink{code/hello4.hny} Loop for some time, but don't have to
go on for ever}
\label{fig:hello4}
\end{figure}
...
\end{tabular}
\end{center}
\caption{Method calls and threads}
\label{fig:methodthread}
\end{figure}
...
\end{code}
\caption{\harmonylink{code/hello8.hny} More interleaving}
\label{fig:hello8}
\end{figure}
...
\item Harmony does not support floating point or I/O;
