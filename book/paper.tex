...
\hline
\texttt{$e$ * $e$ * ...} & two or more integers \\
\hline
...
\hline
\texttt{lambda $b$: $e$ end} & $b$ is a bounded variable, $e$ an expression\\
\hline
\end{tabular}
}
\vspace{1em}
...
\hline
\texttt{const b = $e$} & \texttt{b} is a bounded variable, $e$ is a constant expression\\
\hline
\texttt{def m $b$: S} & \texttt{m} is an identifier, $b$ a bounded variable, \texttt{S} a list of statements\\
\hline
\texttt{let $b$ = $e$ [let ...]: S} & $b$ is a bounded variable, $e$ is an expression, \texttt{S} a list of statements\\
\hline
\texttt{if $b$: S} & $b$ is a boolean, \texttt{S} a list of statements\\
\hline
\texttt{while $b$: S} & $b$ is a boolean, \texttt{S} a list of statements\\
\hline
\texttt{for $b$ in $e$: S} & $b$ is a bounded variable, $e$ is a set,
