...
\glsadd{context}%
\index{thread-local}%
One of the registers contains the local variables of the method that
the thread is currently executing.  It is saved and restored by
...
The memory contains a dictionary that maps atoms to Harmony values.
