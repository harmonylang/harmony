...
leader has to try again with an even higher ballot number.
...
message to the acceptors and awaits their \textit{last\_accepted}
values.  If all acceptors respond with \texttt{None}, then the leader
