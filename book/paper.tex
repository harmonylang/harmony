...
\usepackage{xcolor}
\usepackage{hyperref}
\hypersetup{linkbordercolor=blue, pdfborderstyle={/S/U/W 1}}
...
\end{code}
\caption{\cxllink{python/Up.py} Python implementation of Figure~\ref{fig:inc}.}
\label{fig:incpy}
\end{figure}
...
\caption{The
\cxlref{Up.html}{HTML output of running CXL on Figure~\ref{fig:inc}}.
...
\cxlsource{UpEnter}
\end{code}
\caption{\cxllink{code/UpEnter.cxl} Broken attempt at fixing the code of Figure~\ref{fig:inc}.}
\label{fig:incenter}
\end{figure}
...
\caption{The \cxlref{naiveLock.html}{HTML output of running CXL on Figure~\ref{fig:uplock}}.}
...
\caption{The \cxlref{naiveFlags.html}{HTML output of running CXL on Figure~\ref{fig:upflags}}.}
...
\cxlsource{csTAS}
\end{code}
\caption{\cxllink{code/csTAS.cxl} Fixed version of Figure~\ref{fig:uplock} using test-and-set.}
\label{fig:tas2}
\end{figure}
...
\cxlsource{UpLock}
\end{code}
\caption{\cxllink{code/UpLock.cxl} Program of Figure~\ref{fig:inc} fixed with a lock.}
\label{fig:incfixed}
\end{figure}
...
\cxlsource{RWtest}
\end{code}
\caption{\cxllink{code/RWtest.cxl} Test code for Figure~\ref{fig:rwbusy}.}
...
\cxlsource{qsorttest}
\end{code}
\caption{\cxllink{code/qsorttest.cxl} Test program for Figure~\ref{fig:qsort}.}
\label{fig:qsorttest}
\end{figure}
...
\end{code}
\caption{\cxllink{code/BBsematest.cxl} Test program for Figure~\ref{fig:boundedbuffer}.}
\label{fig:bbtest}
\end{figure}
...
\cxlsource{RWqtest}
\end{code}
\caption{\cxllink{code/RWqtest.cxl} Test program for Figure~\ref{fig:RWqueue}.}
\label{fig:RWqtest}
\end{figure}
