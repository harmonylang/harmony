...
(in this case \texttt{incrementer(0)} and \texttt{incrementer(0)})
can run.
...
In our case, Harmony reports a safety violation.
...
The program got to the failed assertion in 4 ``steps.''
...
we will find out, it is possible but not obvious.
\end{problems}
