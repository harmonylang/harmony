...
There are four sections.  The top left shows the source code and bytecode
of the program.  The top right shows the steps in an execution.
The middle section shows the values of the variables at a particular step.
The bottom section shows the state of each process.
...
fails.  Diagnosing the problem, we see that the \textit{lockTaken} variable
...
\begin{figure}
\begin{center}
\includegraphics[width=3in]{figures/pc-crop.pdf}
\end{center}
...
\textit{mutex} and procures \texttt{r\_sema},
