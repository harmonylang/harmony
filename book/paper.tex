...
\texttt{wait} releases the monitor mutex and blocks while trying
...
a process trying to procure it, and then procures the monitor mutex.
...
Mesa.  Mesa introduced various important concepts to programming languages,
including software exceptions and incremental compilation.  Mesa also
incorporated a version of monitors.
However, there are some subtle but important differences with Hoare-style
monitors that make Mesa-style monitors quite unlike split binary semaphores.
