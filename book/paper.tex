...
\begin{itemize}
\item \texttt{nreadersEntered}: the number of readers in the critical section;
\item \texttt{nwritersEntered}: the number of writers in the critical section;
...
\texttt{mutex} and procures \texttt{rsema},
...
\item The remaining reader decrements \texttt{nreadersWaiting} from 1 to 0 and
