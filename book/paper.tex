...
Method \texttt{thread} demonstrates how a local variable can be declared
in Harmony using the \textbf{let} statement---the syntax is similar to
\textbf{for} statements.  \autoref{sec:vars} provides further information.
In this case $p$ contains the address of the \textit{private} entry
