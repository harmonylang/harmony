...
Instead, we can leverage the <{choose}>
expression.
...
\end{code}
\caption{\harmonylink{code/barriertest2.hny} Demonstrating double-barrier pattern}
...
The <{receive}>(<{self}>) method looks for all messages
