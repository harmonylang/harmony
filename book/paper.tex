...
Here we generalize it to allowing multiple producers and multiple consumers
...
\item Implement a GPU allocator.  There are \texttt{N} GPUs identified
by the numbers
...
either only women or only men may be in the dressing room together.
...
\section*{Exercises}
\begin{enumerate}
\item TBD.  starvation-free dressing room
