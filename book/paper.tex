...
(Recall that CXL will try every possible execution.)
...
(for example, using Peterson's algorithm or using \texttt{swap}), and run the code in
Figure~\ref{fig:incfixed} using your own module.
\end{enumerate}
