...
You can go to any point in the execution by clicking on one of the
blocks in the ``execution timelines.''  Using the left and right arrow
keys you can go forwards and backwards one instruction at a time.
With the down and up arrow keys you can go through the execution one
step at a time.
If you hit enter, it will to go to the next line of Harmony code.
