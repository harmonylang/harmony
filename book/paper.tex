...
\item Write a program that computes factorials.
\end{enumerate}
...
\begin{quote}
\begin{itemize}
\item Can you think of a fix to the program?  You can try it out and see
if it works or not.
\end{itemize}
\end{quote}
...
\item Using a script, run Figure~\ref{fig:inc} 1000 times.  How many times does the assertion
fail (if any).
\end{enumerate}
