...
called CXL that help with \emph{testing} concurrent code.
...
know necessarily that the algorithm works for lists with more than
...
feedback to somebody who is trying to construct a proof.
Throughout this book we will include, as much as possible, examples
