...
background in formal methods.  Harmony programs are model checked~\cite{CES86}.
...
using the <{atomically}> keyword.  Finally, Harmony supports
...
and support for continuations and interrupts.  Harmony finds various common
problems automatically without a complicated property specification
language, such as Harmony's ability to find instances of undesirable
busy waiting.
...
develop code for reliable concurrent or distributed applications.
...
Note that this is essentially a form of Partial Order Reduction~\cite{}.
