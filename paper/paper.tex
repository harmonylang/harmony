...
Harmony is heavily based on Python to reduce the learning curve
for users.  Many of Python's powerful constructs and operators are
...
and perhaps surprisingly this has been a bonus for analyzing
such algorithms with Harmony.  Moreover, the Harmony model checker 
can be used to check for memory leaks or access to dangling pointers.
...
eye of the beholder.
Importantly, however, is the notion of modularity that is implied here.
...
\end{center}
\caption{The Dining Philosophers Program in Harmony}
\label{fig:diners}
\end{figure}
...
\end{center}
\caption{The output of running the Dining Philosophers program}
