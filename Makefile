...
charm:
	gcc -Iharmony_model_checker/charm -Iharmony_model_checker/charm/iface -Iharmony_model_checker/charm/calm -Iharmony_model_checker/charm/calm/util -Iharmony_model_checker/charm/calm/engine -o charm.exe -pthread harmony_model_checker/charm/*.c harmony_model_checker/charm/iface/*.c harmony_model_checker/charm/calm/*.c -Iharmony_model_checker/charm/calm/util/*.c -Iharmony_model_checker/charm/calm/engine/*.c
